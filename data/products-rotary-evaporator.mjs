...
export const rotaryEvaporator = [
  {
    ...
    image: "assets/img/products/rotary-evaporator-photo.jpg",
    ...
    subtitle: "LSRE series, 1 L to 100 L rotating flask",
    ...
    long: [
      ...
      "The range runs from LSRE1 through LSRE100 — a 1 L rotating flask on a 0.25 HP drive at the small end, to a 100 L flask with a 1.0 m² condenser and an 8 kW bath at the pilot end. Everything on the range runs on a single-phase 230 V / 50 Hz supply.",
    ],
    features: [
    ...
    spec: [
      ...
      ["Model range", "LSRE1 to LSRE100 — eight models"],
      ...
      ["Catalogue reference", "LSRE series"],
    ],
    dim: {
      caption: "Rotary Evaporator — technical information for the LSRE range",
      cols: [
      ...
      rows: [
        ["LSRE1", "1 L", "20–230", "0.25", "0.10", "0.5", "230 V / 50 Hz", "2"],
        ["LSRE2", "2 L", "20–230", "0.25", "0.10", "1", "230 V / 50 Hz", "2"],
        ["LSRE3", "3 L", "20–230", "0.25", "0.15", "1", "230 V / 50 Hz", "2"],
        ["LSRE5", "5 L", "15–150", "0.25", "0.20", "2", "230 V / 50 Hz", "2"],
        ["LSRE10", "10 L", "0–80", "0.25", "0.20", "6", "230 V / 50 Hz", "4"],
        ["LSRE20", "20 L", "0–80", "0.5", "0.30", "10", "230 V / 50 Hz", "4"],
        ["LSRE50", "50 L", "0–80", "0.5", "0.50", "20", "230 V / 50 Hz", "6"],
        ["LSRE100", "100 L", "0–80", "0.5", "1.0", "20", "230 V / 50 Hz", "8"],
      ],
    ...
    faqs: [
      ...
      ["What supply does it need?", "230 V, 50 Hz across the whole range. Bath rating rises from 2 kW on LSRE1 to 8 kW on LSRE100."],
      ["Which model suits my batch?", "Size on the rotating flask: LSRE1 to LSRE5 are bench units, LSRE10 and LSRE20 sit between lab and pilot, and LSRE50 and LSRE100 are pilot scale. Tell us the batch volume and the solvent and we will confirm the model and the condenser duty."],
    ],
    related: ["apps-chemical-reactor", "shell-and-tube-heat-exchanger", "line-bellow", "pipe-section"],
    keywords: "rotary evaporator, rotary film evaporator, LSRE series rotary evaporator, thin film evaporator, solvent recovery evaporator, vacuum rotary evaporator, 100 litre rotary evaporator, PTFE vacuum seal rotavap",
    featured: true,
  },
];
