...
export const structureFittings = [
...

  {
    ...
    subtitle: "LSCL series, 25 to 50 NB",
    ...
    spec: SPEC({
      ...
      "Suits tube size": "25 to 50 NB",
      "Catalogue reference": "LSCL series",
    }),
    dim: {
    ...
    keywords: "structure coupler, LSCL coupler, cast iron tube coupler, vertical tube coupling, galvanised tube joiner",
  },
...

  {
    ...
    image: "assets/img/products/structure-double-tee-photo.jpg",
    ...
    subtitle: "LSDT series, 25 to 50 NB",
    ...
    spec: SPEC({
      ...
      "Suits tube size": "25 to 50 NB",
      "Catalogue reference": "LSDT series",
    }),
    dim: {
    ...
    related: ["structure-tee", "structure-double-bend", "structure-cross", "structure-tube-galvanised"],
    keywords: "structure double tee, LSDT fitting, cast iron double tee, two plane branch fitting, tubular structure double tee",
  },

  {
    ...
    subtitle: "LSX series, 25 to 50 NB",
    ...
    spec: SPEC({
      ...
      "Suits tube size": "25 to 50 NB",
      "Catalogue reference": "LSX series",
    }),
    dim: {
    ...
    keywords: "structure cross, LSX cross fitting, cast iron cross clamp, tube crossover fitting, tubular structure bracing cross",
  },
...

  {
    ...
    subtitle: "LSPLUG series, 15 to 50 NB",
    ...
    spec: [
      ...
      ["Catalogue reference", "LSPLUG series"],
    ],
    dim: {
      caption: "Plug — sizes",
      cols: ["Cat. Ref.", "NB"],
    ...
    keywords: "structure plug, LSPLUG tube plug, galvanised tube end plug, tube end cap structure, glass plant tube plug",
  },

  {
    ...
    subtitle: "LSSTUD series, 5/16\" to 1/2\"",
    ...
    advantages: [
      ...
      "Works directly with the LSSPT support's 13 mm eye",
    ],
    applications: [
    ...
    spec: [
      ...
      ["Used with", "LSSPT structure supports"],
      ["Catalogue reference", "LSSTUD series"],
    ],
    dim: {
      caption: "Stud — dimensions",
      cols: ["Cat. Ref.", "D", "L"],
      rows: [
        ["LSSTUD5/16-150", "5/16\"", "150"],
        ["LSSTUD3/8-150", "3/8\"", "150"],
        ["LSSTUD1/2-200", "1/2\"", "200"],
      ],
      note: "Length L in mm; diameter D in inches, as printed in the catalogue.",
    },
    faqs: [
      ["Which stud goes with which support?", "All LSSPT supports carry a 13 mm hole, so any of the three studs will pass through. Pick the diameter on the load being hung and the length on the drop you need."],
    ],
    related: ["structure-support", "structure-equal-bracket", "structure-plug", "structure-tube-galvanised"],
    keywords: "structure stud, LSSTUD screwed rod, threaded rod support, tubular structure stud, pipeline hanger rod",
  },
];
...
export const columnSupports = [
  {
    ...
    subtitle: "LSFCSH series, PCD 310 to 710",
    ...
    spec: [
      ...
      ["Catalogue reference", "LSFCSH series"],
    ],
    dim: {
      caption: "Column Base Support Frame — dimensions",
      cols: ["Cat. Ref.", "PCD", "L1", "L", "H"],
      rows: [
        ["LSFCSH 225", "310", "1000", "800", "75"],
        ["LSFCSH 300", "395", "1000", "800", "75"],
        ["LSFCSH 400", "495", "1200", "1000", "75"],
        ["LSFCSH 450", "585", "1200", "1000", "100"],
        ["LSFCSH 600", "710", "1400", "1200", "100"],
      ],
      note: MM + " The catalogue reference number corresponds to the column DN it serves — LSFCSH 225 for a DN 225 column, and so on.",
    },
    faqs: [
      ...
      ["How do I pick a size?", "By column DN. LSFCSH 225 through LSFCSH 600 match DN 225 through DN 600, with the PCD given in the table."],
    ],
    related: ["counter-balance-support", "structure-base", "structure-support", "structure-tube-galvanised"],
    keywords: "column base support frame, LSFCSH support frame, glass column fixed support, channel frame column support, jacking rod column frame, U bolt column support",
  },

  {
    ...
    subtitle: "LSLCB series, DN 225 to DN 600",
    ...
    spec: [
      ...
      ["Catalogue reference", "LSLCB series"],
    ],
    dim: {
    ...
    faqs: [
      ...
      ["Why is there no LSLCB 450?", "The dimension table prints four references — 225, 300, 400 and 600 — while the load table covers five column sizes including 450. Ask us which reference to use for a DN 450 column."],
    ],
    related: ["column-base-support-frame", "structure-support", "structure-base", "structure-tube-galvanised"],
    keywords: "counter balance support, LSLCB support, glass column counterweight, column load relief support, lever counterbalance glass column, column sealing force",
  },
];
