/* =========================================================
   ...
   catalogue pages. Catalogue references (APV…, APVD…, APVE…, APVL…,
   ABAL…, APVT…) are the catalogue's own.
...
export const glassValves = [
  {
    ...
    long: [
      ...
      "Five references cover DN 15 to DN 50. Note APV1.5/1, which is a reducing build: a DN 40 line connection with a DN 25 branch, at the same 225 mm length as the full-bore DN 40.",
    ],
    features: [
      ...
      "Reducing build available (APV1.5/1: DN 40 line, DN 25 branch)",
    ],
    advantages: GV_ADV,
    applications: [
    ...
    spec: SPEC({
      ...
      "Face to face": "125 mm to 300 mm",
      "Catalogue reference": "APV series, e.g. APV1.5 = DN 40",
    }),
    dim: {
      caption: "Straight Through Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "DN1", "d", "L", "H"],
      rows: [
        ["APV07", "15", "15", "12", "125", "90"],
        ["APV1", "25", "25", "18", "175", "175"],
        ["APV1.5/1", "40", "25", "18", "225", "175"],
        ["APV1.5", "40", "40", "26", "225", "200"],
        ["APV2", "50", "50", "38", "300", "220"],
      ],
    ...
    faqs: [
      ...
      ["What is APV1.5/1?", "A reducing build: DN 40 on the line side and DN 25 on the branch, at the same 225 mm face-to-face as the full-bore DN 40 (APV1.5)."],
    ...
    keywords: "borosilicate glass straight through valve, glass isolation valve, PTFE spindle glass valve, APV valve, DN 15 to DN 50 glass valve",
    featured: true,
  },

  {
    ...
    spec: SPEC({
      ...
      "Catalogue reference": "APVD series, e.g. APVD2 = DN 50",
    }),
    dim: {
      caption: "Drain Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "DN1", "d", "L", "H", "D"],
      rows: [
        ["APVD07", "15", "15", "12", "125", "90", "14"],
        ["APVD1", "25", "25", "18", "175", "175", "28"],
        ["APVD1.5/1", "40", "25", "18", "225", "175", "28"],
        ["APVD1.5", "40", "40", "26", "225", "200", "42"],
        ["APVD2", "50", "50", "38", "300", "220", "50"],
      ],
    ...
    keywords: "borosilicate glass drain valve, glass low point drain, APVD valve, glass pipeline drain valve",
  },

  {
    ...
    spec: SPEC({
      ...
      "Catalogue reference": "APVE series, e.g. APVE1.5 = DN 40",
    }),
    dim: {
      caption: "Angle Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "DN1", "d", "L", "H", "D"],
      rows: [
        ["APVE07", "15", "15", "12", "50", "80", "90°"],
        ["APVE07", "15", "15", "12", "50", "80", "80°"],
        ["APVE1", "25", "25", "18", "100", "175", "90°"],
        ["APVE1", "25", "25", "18", "100", "175", "80°"],
        ["APVE1.5", "40", "40", "26", "150", "200", "90°"],
        ["APVE2", "50", "50", "38", "150", "200", "90°"],
      ],
      note: MM + " On this table <strong>D is the included angle in degrees, not a diameter</strong>. APVE07 and APVE1 are each listed twice — the same reference and dimensions in a 90° and an 80° build — and both rows are reproduced exactly as printed. Quote the angle with the reference when ordering.",
    },
    faqs: [
      ["Why is APVE07 listed twice?", "Because the catalogue prints it twice — once at 90° and once at 80°, with identical DN, d, L and H. The reference alone does not distinguish them, so state the angle you need on the order."],
    ...
    keywords: "borosilicate glass angle valve, 90 degree glass valve, 80 degree glass valve, APVE valve, glass corner isolation valve",
    featured: true,
  },

  {
    ...
    long: [
      ...
      "The catalogue lists two builds. Type A covers DN 15, 25 and 40 under the APVL references; Type B covers DN 25 and 40 under APVLR. Every size shares the same small vent bore — D 11 mm and d 10 mm — because the vent only has to pass air, not process fluid.",
    ...
    features: [
      "Type A (APVL) and Type B (APVLR) builds",
    ...
    spec: SPEC({
      ...
      "Builds": "Type A (APVL series) and Type B (APVLR series)",
      "Catalogue reference": "APVL / APVLR series, e.g. APVLR1 = DN 25 Type B",
    }),
    dim: {
      caption: "Vent Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "D", "d", "L", "Type"],
      rows: [
        ["APVL07", "15", "11", "10", "125", "A"],
        ["APVL1", "25", "11", "10", "150", "A"],
        ["APVL1.5", "40", "11", "10", "150", "A"],
        ["APVLR1", "25", "11", "10", "150", "B"],
        ["APVLR1.5", "40", "11", "10", "150", "B"],
      ],
    ...
    faqs: [
      ["What is the difference between Type A and Type B?", "The catalogue separates them by reference — APVL is Type A, APVLR is Type B — and gives both the same DN, D, d and L. It does not describe the constructional difference, so tell us your duty and we will confirm which build suits it."],
    ...
    keywords: "borosilicate glass vent valve, glass air vent, APVL valve, APVLR valve, high point vent glass pipeline",
  },

  {
    ...
    spec: SPEC({
      ...
      "Catalogue reference": "ABAL series, e.g. ABAL2 = DN 50",
    }),
    dim: {
      caption: "Bottom Outlet Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "DN1", "DN2", "d", "L", "L1", "B"],
      rows: [
        ["ABAL1.5", "40", "25", "25", "26", "260", "105", "190"],
        ["ABAL2", "50", "40", "25", "38", "260", "105", "190"],
      ],
    ...
    faqs: [
      ...
      ["Why is the bottom outlet DN 25 on both sizes?", "That is how the table is printed — DN2 is 25 for both ABAL1.5 and ABAL2. The vessel connection DN and side outlet DN1 are what change between them."],
    ],
    related: ["drain-valve", "straight-through-valve", "u-bend-bottom-outlet", "ptfe-lined-flush-bottom-valve"],
    keywords: "borosilicate glass bottom outlet valve, glass vessel outlet valve, ABAL valve, flush bottom glass valve, reactor bottom outlet",
    featured: true,
  },

  {
    ...
    spec: SPEC({
      ...
      "Catalogue reference": "APVT series, e.g. APVT1.5 = DN 40",
    }),
    dim: {
      caption: "Three Way Valve — dimensions",
      cols: ["Cat. Ref.", "DN", "DN1", "d", "L", "L1", "L2", "H"],
      rows: [
        ["APVT1", "25", "25", "18", "180", "170", "100", "175"],
        ["APVT1.5", "40", "40", "26", "220", "215", "150", "200"],
        ["APVT2", "50", "50", "38", "250", "250", "150", "220"],
      ],
    ...
    keywords: "borosilicate glass three way valve, glass diverter valve, APVT valve, glass changeover valve, DN 50 three way glass valve",
  },
];
