...
export const heatExchangers = [
  {
    ...
    image: "assets/img/products/shell-and-tube-heat-exchanger.svg",
...
export const coilExchangers = [
  {
    ...
    subtitle: "AHEB series, 0.15 m² to 1.30 m²",
    ...
    spec: [
      ...
      ["Jacket capacity", "2 to 40 litres"],
      ["Catalogue reference", "AHEB series"],
    ],
    dim: {
      ...
      rows: [
        ["AHEB4", "100", "25", "25", "375", "100", "A", "0.15", "40", "2"],
        ["AHEB4/4", "100", "100", "25", "400", "100", "B", "0.15", "40", "3"],
        ["AHEB6", "150", "40", "25", "450", "100", "A", "0.35", "50", "5"],
        ["AHEB6/6", "150", "150", "25", "500", "100", "B", "0.35", "50", "7"],
        ["AHEB9", "225", "40", "25", "700", "100", "A", "1.00", "150", "16"],
        ["AHEB9/9", "225", "225", "25", "700", "100", "B", "1.00", "180", "20"],
        ["AHEB12/12", "300", "300", "25", "700", "125", "B", "1.30", "330", "40"],
      ],
    ...
    faqs: [
      ...
      ["What is the difference between Type A and Type B?", "The DN1 connection. Type A has a reduced side connection — 25 mm on AHEB4, 40 mm on AHEB6 and AHEB9. Type B has a full-bore DN1 equal to the shell, which suits a higher vapour load."],
      ["How do I size one?", "On duty. Take the average heat transfer as 350 Kcal/m²hr·°C at 3.5 bar steam, and pick the free actual H.T.A. that meets it — 0.15 m² at the smallest to 1.30 m² on AHEB12/12. Send us the vapourisation rate and we will confirm."],
    ],
    related: ["product-cooler", "shell-and-tube-heat-exchanger", "supporting-clamp", "apps-chemical-reactor"],
    keywords: "glass boiler, AHEB boiler, coil boiler glass shell, reboiler distillation glass, steam coil vapouriser, 350 kcal heat transfer boiler",
    featured: true,
  },

  {
    ...
    subtitle: "AHEC series, 0.10 m² to 1.25 m²",
    ...
    spec: [
      ...
      ["Catalogue reference", "AHEC series"],
    ],
    dim: {
      caption: "Product Cooler — dimensions and duty",
      cols: ["Cat. Ref.", "DN", "DN1", "DN2", "L", "Actual H.T.A. (m²)"],
      rows: [
        ["AHEC 2/1", "50", "25", "16", "450", "0.10"],
        ["AHEC 2/1.5", "50", "25", "16", "600", "0.15"],
        ["AHEC 2/2", "50", "25", "16", "600", "0.20"],
        ["AHEC 3/3.5", "80", "25", "16", "600", "0.35"],
        ["AHEC 4/5", "100", "25", "19", "600", "0.50"],
        ["AHEC 6/10", "150", "25", "25", "600", "2.70"],
        ["AHEC 6/15", "150", "25", "25", "850", "1.25"],
      ],
      note: MM + " ⚠️ The H.T.A. figure for AHEC 6/10 reads as 2.70 on the supplied page, which is inconsistent both with the reference pattern (where the figure after the slash is ten times the area, giving 1.00) and with AHEC 6/15, which is a longer unit at 1.25 m². Confirm this one figure with us before sizing against it. Every other row follows the pattern exactly.",
    },
    faqs: [
      ...
      ["Why is one area figure flagged?", "AHEC 6/10 prints as 2.70 m², but the reference numbering implies 1.00 m² and the longer AHEC 6/15 is listed at 1.25 m². A shorter unit cannot have more than twice the area of a longer one in the same shell, so we have flagged it rather than publish it as fact. Ask us and we will confirm against the master drawing."],
    ...
    keywords: "product cooler, AHEC product cooler, distillate cooler glass, coil battery cooler, glass liquid cooler, 25 DN distillate cooler",
  },
];
...
export const hxAccessories = [
  {
    ...
    subtitle: "ARSP series, DN 150 to DN 300",
    ...
    spec: [
      ...
      ["Bolt size (d)", "30 mm"],
      ["Catalogue reference", "ARSP series"],
    ],
    dim: {
      caption: "Supporting Clamp — dimensions",
      cols: ["Cat. Ref.", "DN", "L", "H", "T", "d"],
      rows: [
        ["ARSP6/30", "150", "150", "487", "10", "30"],
        ["ARSP9/30", "225", "220", "525", "10", "30"],
        ["ARSP12/30", "300", "300", "565", "10", "30"],
      ],
      note: MM,
    },
    faqs: [
    ...
    keywords: "supporting clamp, ARSP clamp, heat exchanger support clamp, horizontal shell and tube support, glass shell clamp",
  },

  {
    ...
    long: [
      ...
      "One reference covers the range: APMC1/1.75, a 25 DN connection with a 22 mm hose spigot and 70 mm length.",
    ],
    features: [
    ...
    spec: [
      ...
      ["Length (L)", "70 mm"],
      ["Supplied with", "Metal flange, rubber gasket and nut bolt"],
      ["Catalogue reference", "APMC series"],
    ],
    dim: {
    ...
    keywords: "angled hose connector, APMC hose connector, condenser hose connector, flexible hose glass connector, coolant hose fitting glass",
  },
];
